  ...
  pages: [
    {
      slides: [
        ...
        // image
        {
          ...
          description:
            `У нас нет ограничений на кол-во загружаемых фото для одного лука. 

Больше фото --> больше ракурсов и деталей, на которые обратят внимание стилисты --> лучше разбор от стилиста. 

По одной фото бывает очень сложно написать хороший разбор 🤷🏻‍♂️
`,
          button: 'Дальше',
        },
        ...
        // sticker
        {
          ...
          description:
            `Добавь комментарий к отправляемому луку. Например, куда планируешь надевать или идти в образе. Можно добавить информацию о себе и своих предпочтениях. Так у стилистов будет больше деталей, на которые они обратят внимание и учтут при составлении своих рекомендаций. 
Также можно задавать свои вопросы через комментарии, на которые ответит стилист.`,
          button: 'Дальше',
        },
        // sticker
        {
          ...
          shape: 'square',
          pagination: 'count',
          title: 'Подпишись на наш канал <a href="https://t.me/Lookwhiz">@Lookwhiz</a',
          description: `- стилисты делятся своими знаниями, полезными материалами, своим опытом, мнением и рекомендациями<br />
- актуальная информация и свежие тренды из мира моды от участников комьюнити Lookwhiz<br />
- интересные луки, образы с улиц и их разборы<br />
- обзоры брендов<br />
- информация об ивентах, распродажах, скидках и спец предложениях<br />
- больше информации о нашей команде и наших проектах<br />
- новости и обновления проекта<br /><br />

А бонусом к подписке ты получаешь бесплатные луки на баланс каждые 3 месяца 🎁`,
          //textAlign: 'center',
          button: {
            content: 'В начало',
            to: '/',
